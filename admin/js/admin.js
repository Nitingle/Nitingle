...
if(candidateForm.date_of_birth.value=="")
{
errorMessage+="date_of_birth not filled!\n";
validationVerified=false;
}
if(candidateForm.mobile.value=="")
{
errorMessage+="mobile not filled!\n";
validationVerified=false;
}
if(candidateForm.aadhar.value=="")
{
errorMessage+="aadhar not filled!\n";
validationVerified=false;
}
if(candidateForm.city.value=="")
{
errorMessage+="city not filled!\n";
validationVerified=false;
}
if(candidateForm.state.value=="")
{
